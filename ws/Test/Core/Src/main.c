...
//	TxBuffer[40] = '\0';
//	sprintf((char*)TxBuffer,(uint8_t *)str,RxBuffer);
...
//	  uint8_t rxByte;
//
//	  	  	  if (HAL_UART_Receive(&hlpuart1, &rxByte, 1, 10) == HAL_OK)
//	        {
//	            if (Task1 == '\r' || Task1 == '\n')
//	            {
//
//	            }
//	            else if (rxByte == 'A' || rxByte == 'a')   // รองรับทั้ง A พิมพ์ใหญ่ และ a พิมพ์เล็ก
//	            {
//	                UART_Print("LED Toggled!\r\n");
//
//	                // คำสั่งสลับสถานะไฟ LED (ติด -> ดับ, ดับ -> ติด)
//	                HAL_GPIO_TogglePin(GPIOA, GPIO_PIN_5);
//
//	                /* * หมายเหตุ: ถ้าใน CubeMX คุณตั้งชื่อ Pin ไว้ว่า LD2 (ค่า Default ของบอร์ด Nucleo ส่วนใหญ่)
//	                 * ให้เปลี่ยนบรรทัดบนเป็น: HAL_GPIO_TogglePin(LD2_GPIO_Port, LD2_Pin);
//	                 */
//	            }
//	            else if (rxByte == '0')                    // สมมติพิมพ์ 0 ให้ปิดไฟบังคับเลย
//	            {
//	                UART_Print("LED OFF\r\n");
//	                HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_RESET);
//	            }
//	            else if (rxByte == '1')                    // สมมติพิมพ์ 1 ให้เปิดไฟบังคับเลย
//	            {
//	                UART_Print("LED ON\r\n");
...
//	  	stdin += Task1[3];
//	  	volt = stdin;
//	  	  if (Task1[0]=='V'||volt>=0||volt<=255){
//	  		UART_Print("Done\n");
//	  	  }
//	  	  else
//	  	  {
//	  		UART_Print("Sum thing went wrong\r\n");
//	  	  }
